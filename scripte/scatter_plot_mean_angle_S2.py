...
folder_path = r"C:\Users\Paula Woest\OneDrive\Desktop\Bachelore Arbeit\Paula\output_data\Session 2_Interaction"
# %%
# Load the feature matrix CSV file
feature_matrix = pd.read_csv(
    r"C:\Users\Paula Woest\OneDrive\Desktop\Bachelore Arbeit\Paula\output_data\Session 2_Interaction\1min_data_feature_matrix_session2.csv"
)

# Extract relevant data (modify column names as necessary)
sus = feature_matrix[feature_matrix["sus_res"] == "sus"]["mean_angle"].values[:10]
res = feature_matrix[feature_matrix["sus_res"] == "res"]["mean_angle"].values[:9]
# %%
import numpy as np

# Create the DataFrame for plotting
data = {
    "mean_angle": np.concatenate([sus, res]),
...
plt.ylabel("mean_angle", fontsize=12)
plt.ylim(30, 55)
plt.grid(alpha=0.3)
