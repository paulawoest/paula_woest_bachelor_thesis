...
# Read both CSV files
file1 = pd.read_csv(
    r"C:\Users\Paula Woest\OneDrive\Desktop\Bachelore Arbeit\Paula\output_data\Session 2_Interaction\1min_mean_location_session2.csv"
)  # Contains first set of features
file2 = pd.read_csv(
    r"C:\Users\Paula Woest\OneDrive\Desktop\Bachelore Arbeit\Paula\output_data\Session 2_Interaction\1min_mean_angle_2.csv"
)
file3 = pd.read_csv(
    r"C:\Users\Paula Woest\OneDrive\Desktop\Bachelore Arbeit\Paula\output_data\Session 2_Interaction\1min_mean_length_2.csv"
)
file4 = pd.read_csv(
    r"C:\Users\Paula Woest\OneDrive\Desktop\Bachelore Arbeit\Paula\output_data\Session 2_Interaction\1min_mean_distance_2.csv"
)
file5 = pd.read_csv(
    r"C:\Users\Paula Woest\OneDrive\Desktop\Bachelore Arbeit\Paula\output_data\Session 2_Interaction\1min_speed_iqr_median_2.csv"
)
file6 = pd.read_csv(
...
folder_path = os.path.join(
    root_path, "output_data", "1min_data_feature_matrix_session2.csv"
)

# Save in_roi_ang_dir dataframe as .csv file
combined_features_5.to_csv(folder_path, index=False)
# %%
