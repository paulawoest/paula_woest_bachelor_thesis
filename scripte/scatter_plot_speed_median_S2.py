...
sus = feature_matrix[feature_matrix["sus_res"] == "sus"]["median_speed"].values[:10]
res = feature_matrix[feature_matrix["sus_res"] == "res"]["median_speed"].values[:9]
# %%
import numpy as np

# Create the DataFrame for plotting
data = {
    "median_speed": np.concatenate([sus, res]),
...
plt.ylabel("median_speed", fontsize=12)
plt.ylim(0.2, 1.5)
plt.grid(alpha=0.3)
